        ...
        <div className="lg:col-span-6 space-y-8 flex flex-col justify-center text-center lg:text-left">
          <div className="space-y-4">
            ...
            <p className="text-zinc-400 text-sm sm:text-base max-w-xl mx-auto lg:mx-0 leading-relaxed">
              Sign in to resume tracking your micro-tasks, release ongoing milestones, and instantly connect with your workspace contracts.
            </p>
          </div>
          ...
          <Card className="w-full max-w-md p-6 shadow-2xl border border-zinc-800 bg-[#0E0E14]">
            ...
            <form onSubmit={handleSignup} className="flex flex-col gap-5">
              <TextField isRequired name="email" type="email" className="flex flex-col gap-1.5">
                ...
                <InputGroup className="flex items-center gap-2 border border-zinc-800 rounded-xl px-3 bg-zinc-900 focus-within:border-emerald-500 transition-colors">
              ...
              <TextField isRequired name="password" className="flex flex-col gap-1.5">
                ...
                <InputGroup className="flex items-center gap-2 border border-zinc-800 rounded-xl px-3 bg-zinc-900 focus-within:border-emerald-500 transition-colors">
                  ...
                  <Input
                    ...
                    className="w-full bg-transparent py-2 text-sm outline-none border-none ring-0 focus:ring-0 text-zinc-100"
                  />
                  <button className="focus:outline-none text-zinc-400 hover:text-zinc-200 transition" type="button" onClick={toggleVisibility}>
