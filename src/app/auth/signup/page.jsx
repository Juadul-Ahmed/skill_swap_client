                ...
                <div className="lg:col-span-6 space-y-8 flex flex-col justify-center text-center lg:text-left">
                    <div className="space-y-4">
                        ...
                        <p className="text-zinc-400 text-sm sm:text-base max-w-xl mx-auto lg:mx-0 leading-relaxed">
                            Create your unified account to tap into a high-performance network. Instantly coordinate secure contract deliverables, lock down escrow configurations, and clear milestones.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-xl mx-auto lg:mx-0 text-left">
                        <div className="p-4 rounded-xl border border-white/5 bg-white/[0.02] space-y-1">
                            <h4 className="text-xs font-bold uppercase tracking-wider text-emerald-400">Escrow Protections</h4>
                            <p className="text-xs text-zinc-400">Funds stay completely safe until your milestones evaluate perfectly.</p>
                        </div>
                        <div className="p-4 rounded-xl border border-white/5 bg-white/[0.02] space-y-1">
                            <h4 className="text-xs font-bold uppercase tracking-wider text-cyan-400">0% Built-in Risk</h4>
                            <p className="text-xs text-zinc-400">Source vetted developers or bid straight onto micro-tasks instantly.</p>
                        </div>
                    </div>
                </div>
                        ...
                        <form onSubmit={handleSignup} className="flex flex-col gap-5">
                            ...
                            <div className="flex flex-col gap-2 border border-zinc-800 rounded-xl p-4 bg-zinc-900/40">
                                <div className="flex items-center gap-2 text-zinc-300">
                                    ...
                                    <span className="text-sm font-medium">Select Marketplace Role</span>
                                </div>
                                ...
                                >
                                    {/* Client Option */}
                                    <Radio value="client">
                                        <Radio.Content className="flex items-center gap-2 text-xs font-medium text-zinc-300 cursor-pointer">
                                            <Radio.Control className="border border-zinc-600 rounded-full w-4 h-4 flex items-center justify-center transition-all data-[selected=true]:border-emerald-500 data-[selected=true]:bg-emerald-500">
                                                <Radio.Indicator className="w-1.5 h-1.5 rounded-full bg-white scale-0 data-[selected=true]:scale-100 transition-transform" />
                                            </Radio.Control>
                                            Client
                                        </Radio.Content>
                                    </Radio>
                            ...
                            <div className="text-center pt-4 border-t border-zinc-800 mt-2 text-sm text-zinc-400">
                                ...
                                <Link href="/auth/signin" className="font-medium cursor-pointer text-sm text-emerald-400 hover:text-emerald-300 transition-colors">
                                    Sign in instead
                                </Link>
                            </div>
