      ...
      <div className="max-w-6xl mx-auto space-y-8 relative z-10">
        ...
        <div>
          ...
          <p className="text-zinc-400 text-sm max-w-xl">
            Review freelancer applications for your tasks. Accept to proceed to
            payment or reject to pass.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {[
            ...
            <div
              key={stat.label}
              className="bg-[#0E0E12]/90 border border-zinc-900/80 rounded-2xl p-5"
            >
        ...
        {total === 0 ? (
          <div className="flex flex-col items-center justify-center py-32 text-center bg-[#0E0E12]/90 border border-zinc-900/80 rounded-3xl">
            ...
            <p className="text-zinc-500 text-sm mb-6">
              Freelancers haven't applied to your tasks yet.
            </p>
            <Link
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      ...
                      <span
                        className={`text-[10px] font-bold uppercase tracking-wider ${
                          group.taskStatus === "in-progress"
                            ? "text-emerald-400"
                            : group.taskStatus === "open"
                              ? "text-yellow-400"
                              : "text-zinc-400"
                        }`}
                      >
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                          ...
                          <div className="space-y-2 flex-1">
                            <div className="flex items-center gap-2 flex-wrap">
                              ...
                              <span
                                className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-black uppercase tracking-wider border ${statusStyle.bg} ${statusStyle.border} ${statusStyle.text}`}
                              >
                                {proposal.status}
                              </span>
                            </div>
                          ...
                          <div className="flex sm:flex-col items-center sm:items-end gap-4 sm:gap-3 shrink-0">
                            <div className="text-right">
                              <div className="text-[10px] font-black text-zinc-600 uppercase tracking-widest mb-0.5">
                                Bid
                              </div>
