...
const BrowseTasksPage = async ({ searchParams }) => {
  ...
  const user = await getUserSession(); // ✅ get session
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
        <div className="mb-12">
          ...
          <p className="text-zinc-400 text-sm md:text-base max-w-xl">
            Find your next project. Browse open tasks posted by clients and
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between">
                    <span
                      className={`inline-flex items-center px-2.5 py-1 rounded-lg text-[10px] font-black uppercase tracking-wider border ${catStyle.bg} ${catStyle.border} ${catStyle.text}`}
                    >
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-[10px] font-bold text-zinc-600 uppercase tracking-widest mb-0.5">
                        Budget
                      </div>
                  ...
                  {isClient ? (
                    ...
                    <Link
                      href={`/auth/signin?redirect=/tasks/${task._id}`}
